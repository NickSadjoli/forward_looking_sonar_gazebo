...
/*
* Copied implementation of Time object from Rock's base Time class
*/
...
namespace gazebo
{
	...
	/** Convert time into a string
         ...
         **/
	std::string toString(gazebo::Time::Resolution resolution = Microseconds, const std::string& mainFormat = "%Y%m%d-%H:%M:%S") const;
    ...
    std::ostream& operator << (std::ostream& io, gazebo::Time const& time);
}
